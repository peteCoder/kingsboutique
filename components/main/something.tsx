...
export function CarouselTransitionAnother({
  heroBanner,
}: {
          ...
          >
            ...
            >
              <div className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 text-white text-center max-w-[40rem] flex flex-col gap-3">
                ...
                <div className="">
                  <Button className="md:min-w-[10rem] md:min-h-[3rem] dark:text-white">
                    Shop Now!
                  </Button>
                </div>
              </div>
                  ...
                  {banner?.category && (
                    <div className="">
                      ...
                      <Button
                        ...
                        className="md:min-w-[10rem] md:min-h-[3rem] uppercase text-white"
                      >
                        Shop Now
                      </Button>
                    </div>
